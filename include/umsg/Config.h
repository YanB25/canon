...
constexpr static size_t kOutStandingRecvBufferNr =
    handle_client_node_nr_per_server() * (kMaxAppThread / NR_DIRECTORY) *
...
constexpr static size_t kPostMessageSize = 64 + 40;
...
// constexpr static size_t kMaxCQE =
//     handle_client_node_nr_per_server() * kMaxAppThread * (kMaxRecvWr) -1;
constexpr static size_t kMaxCQE = kOutStandingRecvBufferNr;
