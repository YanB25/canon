...
static inline double mehcached_pow_approx(double a, double b)
{
    // from
...
static inline void mehcached_zipf_init(struct zipf_gen_state *state,
                                       uint64_t n,
                                       double theta,
                                       uint64_t rand_seed)
{
...
static inline void mehcached_zipf_init_copy(
...
static inline void mehcached_zipf_change_n(struct zipf_gen_state *state,
                                           uint64_t n)
{
...
static inline double mehcached_zeta(uint64_t last_n,
                                    double last_sum,
                                    uint64_t n,
                                    double theta)
{
...
static inline uint64_t mehcached_zipf_next(struct zipf_gen_state *state)
{
...
inline void mehcached_test_zipf(double theta)
{
