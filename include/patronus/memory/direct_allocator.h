...
{
class DirectAllocator : public ::mem::IAllocator
{
public:
 ...
 */
class RawAllocator : public ::mem::IAllocator
{
public:
...
class MallocAllocator : public ::mem::IAllocator, public ::mem::BaseAllocator
{
public:
    ...
    void *alloc(size_t size, size_t alignment) override
    {
        ...
        {
            DCHECK(util::is_power_of_two(alignment));
                ...
                [[maybe_unused]] CoroContext *ctx = nullptr) override
    {
        ...
        // DLOG(INFO) << "malloc(" << size << "): " << (void *) ret;
        allocated_nr_.fetch_add(1, std::memory_order_relaxed);
        return ret;
    }
    void free(void *addr, [[maybe_unused]] CoroContext *ctx = nullptr) override
