...
public:
    ...
    bool commit(AsyncContext<RDMA> *, WRID &o_wrid);
...
private:
    bool commit_wo_mw_reuse_optimization(AsyncContext<RDMA> *, WRID &o_wrid);
    bool commit_with_mw_reuse_optimization(AsyncContext<RDMA> *, WRID &o_wrid);
